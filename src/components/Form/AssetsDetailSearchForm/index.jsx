...
const AssetsDetailSearchForm = props => {
  ...
  useEffect(() => {
    console.log(' AssetsDetail  init 变化 ： ', props.init); //
    form.setFieldsValue(props.init);
  }, [props.init]);
  ...
  // console.log(
  //   ' %c AssetsDetailSearchForm 组件 this.state, this.props ： ',
  ...
  const onClientChange = (params, item) => {
    console.log(' AssetsDetailSearchForm onClientChange  ： ', params, item);
  ...
  const onHouseNoChange = (params, item) => {
    console.log(
      ' AssetsDetailSearchForm onHouseNoChange  ： ',
      params,
      item,
      houseNoList,
      form.getFieldsValue(),
...
export default AssetsDetailSearchForm;
