...
import { actions, mapStateToProps,  } from '@/models/transfer'//
...
class Transfer extends PureComponent {
  ...
  renderTable = params => {
    ...
    return <TransferTable {...tableProps}   ></TransferTable>
  }
  ...
  render() {
    console.log(' %c Transfer 组件 this.state, this.props ： ', `color: #333; font-weight: bold`, this.state, this.props,  )// 
