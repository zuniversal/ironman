...
import ShiftsForm from '@/components/Form/ShiftsForm'; //
import ShiftsTable from '@/components/Table/ShiftsTable'; //
import ResultModal, {ErrorInfo, } from '@/components/Modal/ResultModal'; //

import { actions, mapStateToProps,  } from '@/models/shifts'//
...
class Shifts extends PureComponent {
  ...
  render() {
    console.log(' %c Shifts 组件 this.state, this.props ： ', `color: #333; font-weight: bold`, this.state, this.props,  )// 
