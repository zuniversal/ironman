...
import { DOWN_ASSETS_TPL, ASSETS } from '@/constants';
...
class Assets extends PureComponent {
  ...
  saveTreeNodeAsync = params => {
    ...
    this.props.editItemAsync(params);
  ...
  componentDidMount() {
    ...
    //   customer_id: '6464',
    // });
    this.props.getListAsync(this.props.location.query);
  }

  render() {
    console.log(
      ' %c AssetsDetail 组件 this.state, this.props ： ',
