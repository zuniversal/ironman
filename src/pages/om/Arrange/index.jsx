...
import ArrangeForm from '@/components/Form/ArrangeForm'; //
import ArrangeTable from '@/components/Table/ArrangeTable'; //
import ResultModal, {ErrorInfo, } from '@/components/Modal/ResultModal'; //

import { actions, mapStateToProps,  } from '@/models/arrange'//
...
// const mapStateToProps = ({ arrange, }) => arrange;
...
class Arrange extends PureComponent {
  ...
  renderTable = params => {
    ...
    return <ArrangeTable {...tableProps}   ></ArrangeTable>
  }
  ...
  render() {
    console.log(' %c Arrange 组件 this.state, this.props ： ', `color: #333; font-weight: bold`, this.state, this.props,  )// 
