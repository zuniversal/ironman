...
class CanvasProps extends Component<CanvasPropsProps> {
  ...
  componentDidUpdate() {
    if (
      this.state.node !== this.props.data.node ||
      this.state.line !== this.props.data.line ||
      this.state.multi !== this.props.data.multi
    ) {
      this.setState({
        node: this.props.data.node,
        line: this.props.data.line,
  ...
  render() {
    ...
    if (this.state.node) {
      ...
      return <div className={styles.title}>line</div>;
    } else if (this.state.multi) {
      return <div className={styles.title}>multi</div>;
    }
    ...
    return (
      <div>
        ...
        <div className={styles.bottom}>
          <div className={styles.title}>小提示</div>
          <ul className={styles.group}>
