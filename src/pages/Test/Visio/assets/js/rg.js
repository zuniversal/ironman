!(function(t, r) {
  ...
  return (function(t) {
        ...
        it = function(t, r, n) {
          ...
          return (
            ...
            f(J, e)
              ? (n.enumerable
                  ? (f(t, C) && t[C][e] && (t[C][e] = !1),
                    (n = d(n, { enumerable: g(0, !1) })))
                  : (f(t, C) || B(t, C, g(1, {})), (t[C][e] = !0)),
                nt(t, e, n))
              : B(t, e, n)
          );
        },
        ...
        a(v, 'description', {
          ...
          get: function() {
            var t = c(this) ? this.valueOf() : this,
              r = y.call(t);
            if (u(l, t)) return '';
            var n = h ? r.slice(7, -1) : r.replace(g, '$1');
            return '' === n ? void 0 : n;
          },
        }),
    ...
    function(t, r, n) {
      n(8)({ target: 'Array', stat: !0 }, { isArray: n(27) });
    },
    function(t, r, n) {
      'use strict';
      var e = n(8),
      ...
      t.exports = function(t, r, n, s, v, b, x) {
        o(n, r, s);
        var m,
          S,
          w,
        ...
        if (
          (P &&
            ...
            y !== Object.prototype &&
              ...
              (l ||
                i(m) === y ||
                (u ? u(m, y) : 'function' != typeof m[g] && a(m, g, d)),
              c(m, A, !0, !0),
              l && (p[A] = d))),
          'values' == v &&
            M &&
          ...
          if (
            ...
            for (w in S) (h || j || !(w in I)) && f(I, w, S[w]);
        ...
        { target: 'Array', proto: !0, forced: !s('slice') },
        {
          slice: function(t, r) {
            ...
            if (
              ...
              return p.call(y, g, d);
            for (
              e = new (void 0 === n ? Array : n)(v(d - g, 0)), s = 0;
              g < d;
              g++, s++
            )
              g in y && f(e, s, y[g]);
    ...
    function(t, r, n) {
      ...
      t.exports = function(t) {
        ...
        if (
          ...
          for (n = new y((r = c(v.length))); r > b; b++)
            a(n, b, d ? g(v[b], b) : v[b]);
        else
          for (
            p = (l = x.call(v)).next, n = new y();
            !(s = p.call(l)).done;
            b++
          )
            a(n, b, d ? i(l, g, [s.value, b], !0) : s.value);
        return (n.length = b), n;
      };
    },
    function(t, r, n) {
    ...
    function(t, r, n) {
      ...
      if (i('Number', !d(' 0o1') || !d('0b1') || d('+0x1'))) {
        for (
          ...
          c(d, (S = O[A])) && !c(w, S) && h(w, S, y(d, S));
        (w.prototype = b), (b.constructor = w), u(o, 'Number', w);
      }
    },
    function(t, r, n) {
      var e = n(4),
        ...
        return [
          ...
          function(t, i) {
            ...
            for (var b = []; ; ) {
              ...
              if (null === x) break;
              if ((b.push(x), !g)) break;
              '' === String(x[0]) && (v.lastIndex = f(y, u(v.lastIndex), d));
            }
            for (var m, S = '', w = 0, O = 0; O < b.length; O++) {
              x = b[O];
              for (
                var A = String(x[0]),
                  j = l(p(c(x.index), y.length), 0),
                  I = [],
                  M = 1;
                M < x.length;
                M++
              )
                I.push(void 0 === (m = x[M]) ? m : String(m));
              var T = x.groups;
              if (h) {
                var P = [A].concat(I, j, y);
                void 0 !== T && P.push(T);
                var E = String(i.apply(void 0, P));
              } else E = e(A, y, j, I, T, i);
              j >= w && ((S += y.slice(w, j) + E), (w = j + A.length));
            }
            return S + y.slice(w);
          },
        ];
    ...
    function(t, r, n) {
      ...
      (window.registerTools = function() {
        window.Point = window.Le5leTopologyPoint || window.Le5leTopology.Point;
        var t,
        ...
        try {
          for (n.s(); !(t = n.n()).done; ) {
            ...
            window[u.fullname] ||
              (u.anchorsFn &&
                (window[u.fullname + '_anchors'] = new Function(
                  'node',
                  o(e(r), u.anchorsFn),
                )),
              u.drawFn &&
                ((window[u.fullname] = new Function(
                  'ctx',
                  'node',
                  o(e(r), u.drawFn),
                )),
        ...
        (window.arcToCurves = function(t, r, n, e, o, i, u, c, a) {
          ...
          o = l * f + (b = Math.sin((o * Math.PI) / 180)) * s;
          var p = (f = -1 * b * f + l * s) * f,
            v = n * n,
            y = e * e,
            h = (s = o * o) / v + p / y;
          1 < h
            ? ((n *= Math.sqrt(h)), (e *= Math.sqrt(h)), (i = 0))
            : ((h = 1),
              i === u && (h = -1),
              (i = h * Math.sqrt((v * y - v * p - y * s) / (v * p + y * s)))),
            (c =
              l * (s = (i * n * f) / e) -
              b * (p = (-1 * i * e * o) / n) +
              c / 2),
          ...
          var g = Math.cos(i),
            d = Math.sin(i);
          (p = -f * (s * d + e * g)), (v = -f * (n * d - l * g));
          for (var b = [], x = 0; x < u; ++x) {
            (i += o),
              (y = s * (g = Math.cos(i)) - e * (d = Math.sin(i)) + c),
              (h = n * g + l * d + a);
            var m = -f * (s * d + e * g);
            (g = -f * (n * d - l * g)),
              (b[(d = 6 * x)] = Number(p + t)),
